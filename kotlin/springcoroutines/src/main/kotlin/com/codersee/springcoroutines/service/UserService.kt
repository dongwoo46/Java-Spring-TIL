...
class UserService (
    ...
    suspend fun saveUser(user: User): User? = userRepository.byEmail(user.email)
            .firstOrNull()
    ...
    suspend fun findByNameLike(name: String): Flow<User> = userRepository.findByNameContaining(name)
