...
import com.codersee.springcoroutines.repository.ComapnyRepository
...
class CompanyService (
        private val companyRepository: ComapnyRepository
) {
    ...
    suspend fun findByName(name: String): Flow<Company> = companyRepository.findByNameContaining(name)
